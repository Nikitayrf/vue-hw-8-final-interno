  ...
  <section>
    ...
    <div class="page3">
      <div class="page3__left">
        ...
        <ol>
          <li>
            <p class="page3__text">Contrary to popular belief.There are many variations of passages of Lorem Ipsum
      ...
      <div class="page3__right">
        ...
        <div class="tags__wrap">
          <button class="tag" v-for="(tag, index) in tags" :key="index" @click="addFilterTag(index, $event)">
            {{ tag.name }}
          </button>
        </div>
...
export default {
  ...
  computed: {
    ...mapGetters({
      articles: 'articles/firstThreeArticles',
    }),
    articlesFilter() {
